...
`reasoning_effort=low`, `max_tokens=131072`): целиком одним вызовом до 10000 слов, свыше —
...
из субтитров при `--subs`. Ключ — DEEPSEEK_API_KEY (+ DEEPSEEK_BASE_URL) из ~/.hermes/.env;
нет ключа/терминов — honest-degrade.
